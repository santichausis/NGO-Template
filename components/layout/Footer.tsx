 ...
 * FOOTER
 * ------
 * Four-column footer with link groups, social icons, and legal links.
 * Update the link groups in lib/content.ts → footerLinks.
 * Add your 501(c)(3) registration number and country-specific legal text.
 */
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3">
              {[
                { href: siteConfig.socialLinks.twitter, Icon: TwitterIcon, label: "Twitter" },
                ...
                { href: siteConfig.socialLinks.linkedin, Icon: LinkedInIcon, label: "LinkedIn" },
              ].map(({ href, Icon, label }) => (
                <a
                  key={label}
                  href={href}
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-500">
            ...
            reserved.{" "}
            {/* Add your 501(c)(3) EIN number here */}
            Registered 501(c)(3) nonprofit · EIN: 00-0000000
          </p>
